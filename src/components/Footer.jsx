...
function Footer() {
  return (
    <div className='w-full flex justify-between h-screen font-["Founders_Grotesk"] bg-zinc-900 p-24 '>
        <div className='w-12 h-full flex flex-col justify-between  '>
           <div className='headings'>
           <h1 className='text-[6vw] font-semibold uppercase leading-tight -mb-10' >Eye-</h1>
        ...
        <div className='w-1/2'>
        <h1 className='text-[6vw] font-semibold uppercase -mb-10 tracking-tighter' >PRESENTATIONS</h1>
        <div className='dets font-["Neue_Montreal"] mt-16 '>
            <h1 className='text-2xl '>S:</h1>
            <div className='links mt-10'>
            <a className='block text-xl font-light ' href="#">Instagram</a>
            <a className='block text-xl font-light ' href="#">Behance</a>
            <a className='block text-xl font-light ' href="#">Facebook</a>
            <a className='block text-xl font-light ' href="#">Linkedin</a>
            </div>
            

            <h1 className='text-2xl mt-10 '>L:</h1>
            ...
            <a className='block text-xl font-light mt-10 ' href="#">30 Chukarina St</a>
            <a className='block text-xl font-light  ' href="#">Lviv, Ukraine</a>
            </div>


            <h1 className='text-2xl mt-10 '>E:</h1>
            <div className='links mt-3'>
            <a className='block text-xl font-light ' href="#">hello@ochi.design</a>
           
            </div>
        </div>
        <div className='dets-right absolute font-["Neue_Montreal"  '>
            <h1 className='relative font-medium left-[40vw] bottom-[16vw] text-2xl '>M:</h1>
            <a className='block relative  left-[40vw] bottom-[16vw] text-xl font-medium' href="#">Home</a>
            <a className='block relative  left-[40vw] bottom-[16vw] text-xl font-medium' href="#">Services</a>
            <a className='block relative  left-[40vw] bottom-[16vw] text-xl font-medium' href="#">Our Work</a>
            <a className='block relative  left-[40vw] bottom-[16vw] text-xl font-medium' href="#">About us</a>
            <a className='block relative  left-[40vw] bottom-[16vw] text-xl font-medium' href="#">Insights</a>
            <a className='block relative  left-[40vw] bottom-[16vw] text-xl font-medium' href="#">Contact us</a>
        </div>
        </div>
    </div>
  )
